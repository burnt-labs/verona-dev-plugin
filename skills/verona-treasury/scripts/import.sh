#!/bin/bash
#
# verona-treasury/import.sh - Import Treasury configuration
#
...
CMD=(verona-toolkit --no-interactive --network "$NETWORK" treasury import "$ADDRESS" --from-file "$FROM_FILE" --output json)
