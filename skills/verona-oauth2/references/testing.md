...
```bash
# Run with real CLI (requires verona-toolkit installed and configured)
./tests/skills/run_all.sh oauth2

# Requires valid credentials for testnet
# Credentials should be in ~/.verona-toolkit/credentials/testnet.enc
```
